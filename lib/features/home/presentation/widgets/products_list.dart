...
class ProductsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      shrinkWrap: true,
      itemCount: homeCubit.isLoading == true
          ? 10
          : homeCubit.homeEntities.products.length,
      itemBuilder: (BuildContext context, int index) {
        return ProductItem(
          isLoading: homeCubit.isLoading,
          product: homeCubit.homeEntities.products.isNotEmpty
              ? homeCubit.homeEntities.products[index]
              : ProductEntities(
                  name: "",
                  id: 0,
                  price: 0,
